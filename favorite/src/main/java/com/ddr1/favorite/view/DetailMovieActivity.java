...
import static com.ddr1.favorite.db.DatabaseContract.MoviesColumns.ID;
import static com.ddr1.favorite.db.DatabaseContract.MoviesColumns.LANGUAGE;
import static com.ddr1.favorite.db.DatabaseContract.MoviesColumns.OVERVIEW;
import static com.ddr1.favorite.db.DatabaseContract.MoviesColumns.POPULARITY;
...
public class DetailMovieActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.favorite) {
            ...
            values.put(DatabaseContract.MoviesColumns.POSTER, movieItem.getPoster_path());
